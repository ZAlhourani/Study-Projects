...
function displayReviews() {
  ...
  const reviewDiv = document.createElement('div'); //<dive></div>
...
function addRating(parent, numberOfStars) {
  ...
  for (let i = 0; i < numberOfStars; i++){
    const startImageElement = document.createElement('img');
    startImageElement.src = 'img/star.png';

    startImageElement.classList.add('ratingStar');

    ratingDiv.appendChild(startImageElement);
  }
