<template>
  <div class="main">
    ...
    <div class="well-display">
      ...
      <div class="well"><span class="amount">{{ averageRating }}</span>Average Rating</div>
    
      <div class="well"><span class="amount">{{ numberOf1StarReviews }}</span>1 Star Review</div>

      <div class="well"><span class="amount">{{ numberOf2StarReviews }}</span>2 Star Review</div>

      <div class="well"><span class="amount">{{ numberOf3StarReviews }}</span>3 Star Review</div>

      <div class="well"><span class="amount">{{ numberOf4StarReviews }}</span>4 Star Review</div>

      <div class="well"><span class="amount">{{ numberOf5StarReviews }}</span>5 Star Review</div>
    </div>
...
export default {
  ...
  data(){
    return {
      ...
      reviews: [{
        id: 1,
        reviewer: 'Zee Alhourani',
        title: 'Great Book',
        rating: 5,
        review: 'The book is amazing',
        isFavorite: false
      },
    {
      id: 2,
      reviewer: 'Elaine Zedack',
      title: 'Nice Book',
      rating: 2,
      review: 'Ok Book',
      isFavorite: true
