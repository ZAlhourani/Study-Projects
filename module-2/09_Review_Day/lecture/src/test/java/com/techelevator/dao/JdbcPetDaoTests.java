...
public class JdbcPetDaoTests extends BaseDaoTests {
    ...
    public void visitCount_returns_valid_result () {
        ...
        int visitCount = sut.visitCount(246, LocalDate.of(2002, 3,1), LocalDate.of(2002, 5, 30));
    ...
    private void assertPetMatch (Pet expected, Pet actual) {
